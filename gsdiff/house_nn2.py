...
'''This is the Transformer for edge prediction with our random self-supervision strategy.'''
...
class EdgeModel(nn.Module):
    ...
    def forward(self, corners, global_attn_matrix, corners_padding_mask, semantics):
        ...
        edge_semans3 = torch.zeros_like(edge_semans1) # Semantics of randomly interpolated point are unknown
