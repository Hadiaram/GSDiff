...
os.mkdir('./rplandata/Data/rplang-v3-bubble-diagram/test')
...
edgecategory[1] = 0
bubblenumber = {}
test_files = os.listdir('rplandata/Data/rplang-v3-withsemantics/test')
for test_file in tqdm(test_files):
    test_graph = np.load('rplandata/Data/rplang-v3-withsemantics/test/' + test_file, allow_pickle=True).item()
    ...
    np.save(os.path.join('rplandata/Data/rplang-v3-bubble-diagram/test', f"{test_graph['file_id']}.npy"), bbdiagram)
