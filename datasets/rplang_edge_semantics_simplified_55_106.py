...
class RPlanGEdgeSemanSimplified_55_106(Dataset):
    '''
   ...
   to facilitate the data loading. we don't use the order in nn, to meet permutation invariability of graph nodes.)
    ...
    def __getitem__(self, index):
        ...
        '''Random permutation of corner ordering (applied only in train mode to augment data)'''
        # Generate a randomly permuted index array
        permutation_indices = np.random.permutation(53)
    # Use the same permutation indices to reorder both arrays
